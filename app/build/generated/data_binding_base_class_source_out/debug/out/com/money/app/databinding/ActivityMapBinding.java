...
public final class ActivityMapBinding implements ViewBinding {
  ...
  private ActivityMapBinding(@NonNull ConstraintLayout rootView, @NonNull ImageButton btnClose,
      @NonNull View headerBg, @NonNull WebView webView) {
  ...
  public static ActivityMapBinding bind(@NonNull View rootView) {
    ...
    missingId: {
      ...
      return new ActivityMapBinding((ConstraintLayout) rootView, btnClose, headerBg, webView);
    }
